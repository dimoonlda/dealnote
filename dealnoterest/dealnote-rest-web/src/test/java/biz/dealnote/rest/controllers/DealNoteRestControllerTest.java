...
public class DealNoteRestControllerTest{
	...
	public void testSaveDocument() throws Exception{
		...
		when(dtoConverterService.buildDocClassDet(any(DocClassDetDto.class), any(Agent.class)))
			.thenReturn(Optional.of(det));
