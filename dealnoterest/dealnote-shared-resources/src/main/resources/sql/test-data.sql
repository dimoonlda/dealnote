...
INSERT INTO AGENTS (ID, ISACTIVE, SNAME, SUPERVISORID, ROLECODE, USERID, OUTERID, MYCLIENTUID, VSANDPS, ALLOWDISCOUNT, STRICTSTOPSHIP, FIO, EMAIL, IMPORTDATETIME, UPDATEDATETIME, ADMIN_PASS, MONEYNAME, MONEYFORMAT, QTYFORMAT, DAYDELDOC, ISGPS, FREQUENCYGETGPS, FREQUENCYSENDGPS, GPSFROMHOUR, GPSTOHOUR, GPSBYDAY, ISAPPSTAT, ISGPSBEFOREORDER)
            VALUES (444, 1, '370 Додич', NULL, 2, NULL, 581, 9, 1, 1, 0, 'Додичь', 'dodich@ukr.net', '2015-03-25 00:00:00', '2015-03-25 12:52:46', '9YnRQmI2/VyEuu/fRaWMRA==', 'грн.', '##0.##', '##0.##', 10, 1, 10, 60, 9, 18, '1,1,1,1,1,0,0', 0, 0);
INSERT INTO AGENTS (ID, ISACTIVE, SNAME, SUPERVISORID, ROLECODE, USERID, OUTERID, MYCLIENTUID, VSANDPS, ALLOWDISCOUNT, STRICTSTOPSHIP, FIO, EMAIL, IMPORTDATETIME, UPDATEDATETIME, ADMIN_PASS, MONEYNAME, MONEYFORMAT, QTYFORMAT, DAYDELDOC, ISGPS, FREQUENCYGETGPS, FREQUENCYSENDGPS, GPSFROMHOUR, GPSTOHOUR, GPSBYDAY, ISAPPSTAT, ISGPSBEFOREORDER)
            VALUES (495, 1, '32_Кульчицький', NULL, 2, NULL, 3060, 9, 1, 1, 0, 'Додичь', 'dodich@ukr.net', '2015-03-25 00:00:00', '2015-03-25 12:52:46', '9YnRQmI2/VyEuu/fRaWMRA==', 'грн.', '##0.##', '##0.##', 10, 1, 10, 60, 9, 18, '1,1,1,1,1,0,0', 0, 0);
INSERT INTO AGENTS (ID, ISACTIVE, SNAME, SUPERVISORID, ROLECODE, USERID, OUTERID, MYCLIENTUID, VSANDPS, ALLOWDISCOUNT, STRICTSTOPSHIP, FIO, EMAIL, IMPORTDATETIME, UPDATEDATETIME, ADMIN_PASS, MONEYNAME, MONEYFORMAT, QTYFORMAT, DAYDELDOC, ISGPS, FREQUENCYGETGPS, FREQUENCYSENDGPS, GPSFROMHOUR, GPSTOHOUR, GPSBYDAY, ISAPPSTAT, ISGPSBEFOREORDER)
            VALUES (496, 0, '33_Клочко', NULL, 2, NULL, 3080, 9, 1, 1, 0, 'Додичь', 'dodich@ukr.net', '2015-03-25 00:00:00', '2015-03-25 12:52:46', '9YnRQmI2/VyEuu/fRaWMRA==', 'грн.', '##0.##', '##0.##', 10, 1, 10, 60, 9, 18, '1,1,1,1,1,0,0', 0, 0);
...
INSERT INTO DOCCLASS (ID, OUTERID, NAME, DESCRIPTION)
              VALUES (1, NULL, 'F1', 'First form');
INSERT INTO DOCCLASS (ID, OUTERID, NAME, DESCRIPTION)
              VALUES (2, NULL, 'F2', 'Second form');

COMMIT WORK;

INSERT INTO DOCTYPE (ID, PAYFORMID, DOCCLASSID, OUTERID, DAYS, ACCINCRNOVAT, ACCINCRWITHVAT, SNAME, DISCOUNTFIRST, VATOVERSUM)
             VALUES (1, 1, 1, NULL, 30, 2, 2, 'Type1', 1, 1);
INSERT INTO DOCTYPE (ID, PAYFORMID, DOCCLASSID, OUTERID, DAYS, ACCINCRNOVAT, ACCINCRWITHVAT, SNAME, DISCOUNTFIRST, VATOVERSUM)
             VALUES (2, 2, 2, NULL, 30, 2, 2, 'Type2', 1, 1);
INSERT INTO DOCTYPE (ID, PAYFORMID, DOCCLASSID, OUTERID, DAYS, ACCINCRNOVAT, ACCINCRWITHVAT, SNAME, DISCOUNTFIRST, VATOVERSUM)
             VALUES (3, 3, 2, NULL, 30, 2, 2, 'Type3', 1, 1);

COMMIT WORK;

INSERT INTO DOCCLASSDET (ID, DOCCLASSID, AGENTID, REGNUMNEXT, REGNUMPREFIX)
                 VALUES (1, 1, 444, 1000, 'A');
INSERT INTO DOCCLASSDET (ID, DOCCLASSID, AGENTID, REGNUMNEXT, REGNUMPREFIX)
                 VALUES (2, 2, 444, 1000, 'B');
