...
public class GoodsGroupController {
	...
	public String processUpdateForm(@Valid @ModelAttribute("goodsGroup") GoodsGroup goodsGroup,
	...
	public String processCreateForm(@Valid @ModelAttribute("goodsGroup") GoodsGroup goodsGroup,
			SessionStatus status, BindingResult result){
		if(result.hasErrors()){
			return "createOrUpdateGoodsGroupForm";
		}else{
